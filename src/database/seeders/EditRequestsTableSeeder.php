...
class EditRequestsTableSeeder extends Seeder
{
    ...
    {
        $requests = [
            ['name' => '西 玲奈', 'target_date' => '2025-06-01', 'request_date' => '2025-06-02'],
        ...
        foreach ($requests as $req) {
            ...
            $attendance = Attendance::where('user_id', $user->id)->where('date', $req['target_date'])->first();
            ...
            if ($attendance) {
                EditRequest::create([
                    ...
                    'new_rests' => json_encode([['start_time' => '12:30:00', 'end_time' => '13:30:00']]),
                    'note' => '遅延のため',
                    'status' => 'pending',
